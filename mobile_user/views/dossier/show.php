...
<div id="dossier-show" class="gh-center">
	...
	?>
		<p align="center"><a href="../show_photo?id=<?php echo $dossier['id']; ?>&photo=<?php echo urlencode(base_url() . substr($photos[$i], 10)); ?>" data-ajax="false" class="f-cb"><img src="<?php echo nn_fix_uploadurl($photos[$i]); ?>"/></a></p>
	<?php
		}
	?>
	</div>
