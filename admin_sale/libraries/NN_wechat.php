...
class NN_wechat {
	...
	public function __construct($appid = '', $appsecret = '') {
		...
		$this->_token		= 'nn';
		$this->_cache 		= new NN_cache();
		$this->_config 		= $this->_cache->read('config_pub');
		$this->_jssdk 		= new NN_jssdk($this->_config['appid'], $this->_config['appsecret']);
	...
	public function checkSignature() {
		$echoStr = nn_get_param('echostr');
		$signature = nn_get_param('signature');
		$timestamp = nn_get_param('timestamp');
		$nonce = nn_get_param('nonce');
	...
	public function generateMenu($menus_obj) {
		...
		$sendmenu = nn_encode_json($menus_obj);
		$ch = curl_init($url);
