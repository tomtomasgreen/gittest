			...
			$.post('./login',
				{
					...
					if(data.result > 0) {
						window.location = '<?php echo config_item('app_url'); ?>my/index';
					} else {
						nn_enableButton(_btn, '登录');
...
<body data-role="page" class="f-ff1" data-quicklinks="true" data-title="医生登录" data-theme="b">
...
<div data-role="content" class="gh-center">
	...
	<div class="login-form">
		...
		<div class="ui-field-contain">
			...
			if(!$isWeixinBrowser) {
			?>
			<a style="float:right;line-height:4em;" href="<?php echo base_url(); ?>index.php/passport/login" id="role-switch" data-ajax="false">点此进入患者入口</a>
			<?php
			}
			?>
		</div>
		<div class="ui-field-contain"><a id="reg" href="./reset" data-ajax="false">重置密码</a></div>
	</div>
