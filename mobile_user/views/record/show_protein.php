...
<div id="record-show" class="gh-center">
	...
	<div class="navbar">
		<ul class="f-cb">
			...
			<li><a data-ajax="false" href="javascript:;" data-item="protein" class="ui-link ui-btn cur">糖化血红蛋白</a></li>
		</ul>
	</div>
	<div class="records">
		<div class="item item-protein">
			<div class="more"><a class="ui-link ui-btn ui-btn-inline ui-btn-corner-all" href="./more_protein" data-ajax="false">过往数据</a></div>
