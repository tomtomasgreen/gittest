...
class user extends MY_Controller
{
	...
	public function index()
	{
		...
		$page_number = $this->user_model->get_allpages_number();
		$page_number =  count($page_number) ;
		$page_zong = ceil($page_number / 10) ;
		$data = $this->user_model->get_allpages($page_now,10);
		...
		$this->data['group'] = 1 ;
		$this->load->view('user/select.html', $this->data);
	}

	public function add()
	{

		$this->load->view('user/add.html');
	}
	...
	public function select_data()
	{
		...
		$this->load->view('user/select_data.html', $this->data);
	}
	...
	public function search()
	{
		...
		$user_data = $this->record->search($arr);
		...
		$data['group'] = 2;
		$this->load->view('user/select.html', $data);
	}
	...
	function editpwd() {
		...
		$data = array();
		$data['user'] = $user;
		$this->load->view('user/editpwd', $data);
	}
	...
	function updatepwd() {
		...
		$this->user_model->editpwd_by_userid($userid, $password);
		$this->load->view('user/updatepwd');
	}
