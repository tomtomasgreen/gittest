...
<body data-role="page" class="f-ff1" data-quicklinks="true" data-title="科室通知" data-theme="b">
<div data-role="header" data-position="fixed" class="gh-center">
	<h1>科室通知</h1>
	<a href="../my/department" data-icon="back" data-ajax="false">返回</a>
</div>
<div id="task-list" class="gh-center">
	<?php
	if(!$notices_unread && !$notices_read) {
	?>
	<div class="alert">暂时没有任何科室通知~</div>
	<?php
	} else {
	?>
