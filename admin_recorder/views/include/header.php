...
<link href="<?php echo base_url(); ?>public/css/admin_recorder.css" rel="stylesheet">
					...
					<div class="container-fluid">
						...
						<div class="nav-collapse collapse navbar-responsive-collapse">
							...
							<ul class="nav pull-right">
								<li class="dropdown">
									<a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;">数据员<strong class="caret"></strong></a>
									<ul class="dropdown-menu">
										<li><a href="<?php echo config_item('app_url'); ?>recorder/editpwd">修改密码</a></li>
